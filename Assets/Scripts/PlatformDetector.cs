...
public class PlatformDetector : MonoBehaviour
{
    ...
    //True if we have set the position of the platfomr at least once since it was first set.
    ...
    void FixedUpdate()
    {
        //If we are standing on a platfomr
        if (platform != null)
        {
            ...
            {
                //Add the change in the platform position to our trans.position:
            ...
            //Mark that we have logged the position at least once
        }
