...
public class ForceField : MonoBehaviour
{
    ...
    [Tooltip("Should the force be applied in world space or local spave relative to this Transform's facing?")]
    public Space forceSpace = Space.World;

    //Get the force in world space.
    ...
    void OnColliderTouched(Collider other)
    {
        ...
        if (affectsPlayer)
        {
            ...
            if (player != null)
            {
                ...
                else //Otherwise, use teh force as is.
